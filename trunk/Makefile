...
opal-test:
	coffee --compile --bare --join tests/test-opal2.js src/library/opal-test.header.coffee src/library/opal.Array.test.coffee src/library/opal.Object.test.coffee src/library/opal.Function.test.coffee src/library/opal.Number.test.coffee src/library/opal.Nullable.test.coffee
