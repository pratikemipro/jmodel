...
define(function() {
  var Constructor, JMPromise, Type, base1;
  ...
  window.PreconditionError = (function(superClass) {
  ...
  window.PostconditionError = (function(superClass) {
    extend(_Class, superClass);
  ...
  Array.concat = function() {
    ...
    return (ref = []).concat.apply(ref, arrays);
  };
  ...
  Array.zip = function() {
    var arr, arrays, i, j, maxIndex, ref, results;
    arrays = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    ...
    results = [];
    for (i = j = 0, ref = maxIndex; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
  ...
  Array.flatten = function(array) {
    ...
    return Array.concat.apply(Array, (function() {
      ...
      for (j = 0, len = array.length; j < len; j++) {
        arr = array[j];
        results.push(arr instanceof Array ? Array.flatten(arr) : arr);
      }
      return results;
    })());
  };
  ...
  Array.prototype.each = function(fn) {
    ...
    for (j = 0, len = this.length; j < len; j++) {
      item = this[j];
      results.push(fn.call(item, item));
    }
    return results;
  };
  ...
  Function.overload = function(variants) {
    ...
    return fn.extend({
      extend: function(variants2) {
        ...
        return Function.overload(slice.call(variants2).concat(slice.call(variants)));
      }
    });
  };
  ...
  Function.prototype.then = function(fn2) {
    ...
    return function() {
      ...
      val1 = fn1.call.apply(fn1, [context, first].concat(slice.call(rest)));
  ...
  Function.pipe = function() {
    var fn, fns, ref;
    fn = arguments[0], fns = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    if ((ref = typeof fn) !== 'function' && ref !== 'undefined') {
      throw new PreconditionError;
    }
  ...
  Function.compose = function() {
    ...
    switch (arguments.length) {
      ...
      case 0:
        return Function.identity;
      default:
        return Function.pipe.apply(Function, slice.call(arguments).reverse());
    }
  };
  ...
  Function.prototype.post = function(post) {
    ...
    return function() {
      ...
      post.call.apply(post, [this, ret].concat(slice.call(args)));
      return ret;
    };
  };
  ...
  Function.and = Function.From([Function]).To(Function)(function() {
    ...
    predicate = arguments[0], predicates = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    switch (arguments.length) {
      case 1:
        return predicate;
      case 0:
  ...
  Function.delegate = function(fn) {
    return function() {
      ...
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      ref = fn.call(this), context = ref[0], method = ref[1];
  ...
  Function.delegates = function(fn) {
    ...
    for (index = j = 0; j <= 9; index = ++j) {
      results.push((function(index) {
        return function() {
          var args, context, fns, ref;
          args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
          ref = fn.call(this), context = ref[0], fns = 2 <= ref.length ? slice.call(ref, 1) : [];
  ...
  Function.prototype.bind = function() {
    ...
    context = arguments[0], args1 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    fn = this;
    return function() {
      var args2;
      args2 = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return fn.call.apply(fn, [context].concat(slice.call(args1), slice.call(args2)));
    };
  };
  Function.prototype.curry = function() {
    ...
    return function() {
      var args2;
      args2 = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return fn.call.apply(fn, [this].concat(slice.call(args1), slice.call(args2)));
    };
  };
  ...
  Function.prototype.cache = Function.prototype.Cache = function() {
    ...
    fn = this.post(function() {
      var args, ret;
      ret = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      return cache.push({
        args: args,
        ret: ret
      });
    ...
    return function() {
      var args, ref, ref1;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return (ref = (ref1 = lookup(args)) != null ? ref1.ret : void 0) != null ? ref : fn.apply(this, arguments);
    };
  };
  if ((base1 = Function.prototype).delay == null) {
    base1.delay = function() {
      var args1, duration, fn;
      duration = arguments[0], args1 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      if (duration == null) {
        duration = 1;
      }
      fn = this;
      return function() {
        var args2, ref;
        args2 = 1 <= arguments.length ? slice.call(arguments, 0) : [];
        return setTimeout((ref = fn.curry).call.apply(ref, [fn].concat(slice.call(args1), slice.call(args2))), duration);
      };
    };
  }
  ...
  Function.prototype.Where = function(predicate, message) {
    var property, ref, restricted, value;
    if (message == null) {
  ...
  Type.union = Function.From(Function).Returning(function() {
    ...
    return function(fn) {
      var constructor, j, len, name, ref, results, results1, subtype, subtypes;
      ...
      if (subtypes instanceof Array) {
        ...
        for (name in ref) {
          ...
          results1.push((function(name, constructor) {
  ...
  Object.construct = Function.From(Function, [Value])(function() {
    ...
    constructor = arguments[0], args1 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    switch (false) {
      ...
      case constructor !== Date:
        return function() {
          var args, args2;
          args2 = 1 <= arguments.length ? slice.call(arguments, 0) : [];
          args = slice.call(args1).concat(slice.call(args2));
          switch (args.length) {
            case 1:
      ...
      default:
        return function() {
          ...
          })(constructor, slice.call(args1).concat(slice.call(args2)), function(){});
        };
    }
  });
  ...
  Object.has = Function.From(Scalar)(function(key) {
    return Function.From(Object).To(Boolean)(function(object) {
      return indexOf.call(Object.keys(object), key) >= 0;
    });
  });
  ...
  Object.method = Function.overload([
    Function.From(String, [Value])(function() {
      var args1, method;
      method = arguments[0], args1 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      return function() {
        var args2, obj;
        obj = arguments[0], args2 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
        if (!obj[method]) {
          throw new Error('Undefined method');
        }
        return obj[method].apply(obj, slice.call(args1).concat(slice.call(args2)));
      };
    }), Function.From(Function, [Value])(function() {
      var args1, fn;
      fn = arguments[0], args1 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      return function() {
        var args2, obj;
        obj = arguments[0], args2 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
        return fn.call.apply(fn, [obj].concat(slice.call(args1), slice.call(args2)));
      };
    })
  ]);
  Object.resolve = function() {
    var args1, name;
    name = arguments[0], args1 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    return function() {
      var args2, obj;
      obj = arguments[0], args2 = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      if (!obj[name]) {
      ...
      if (typeof obj[name] === 'function') {
        return Object.method.apply(Object, [name].concat(slice.call(slice.call(args1).concat(slice.call(args2)))))(obj);
      } else {
        return Object.property.apply(Object, [name].concat(slice.call(slice.call(args1).concat(slice.call(args2)))))(obj);
      }
    };
  };
  Object.path = function(path, separator) {
    ...
    first = path[0], rest = 2 <= path.length ? slice.call(path, 1) : [];
    switch (path.length) {
      case 0:
  ...
  Object.equal = Predicate.From(Object, Object)(function(a, b) {
    var prop;
    return Array.reduce(Boolean.and)(slice.call((function() {
        var results;
        results = [];
        for (prop in a) {
          if (!hasProp.call(a, prop)) continue;
          results.push(a[prop] === b[prop]);
        }
        return results;
        ...
        results = [];
        for (prop in b) {
          if (!hasProp.call(b, prop)) continue;
          results.push(a[prop] === b[prop]);
        }
        return results;
      })())));
    ...
    return Function.From(Object).Returning(function() {
      ...
      return function(source) {
        ...
        for (key in source) {
          if (!hasProp.call(source, key)) continue;
          value = source[key];
          results.push(obj[renaming[key] || key] = value);
        }
        return results;
      };
    });
  ...
  Object.union = Function.overload([
    Function.From(Array).Returning(function() {
      ...
      return function(objects) {
        var j, key, len, object, results, value;
        results = [];
  ...
  Object.intersection = Function.overload([
    Function.From(Array).Returning(function() {
      ...
      return function(arg) {
        var first, key, rest, results, value;
        ...
        for (key in first) {
          ...
          if (rest.all(Object.has(key))) {
            results.push(intersection[key] = value);
          }
        }
        return results;
      };
      ...
      return function(arg) {
        ...
        for (key in first) {
          ...
          if (rest.none(Object.has(key))) {
            results.push(difference[key] = value);
          }
        }
        return results;
      };
  ...
  Number.In = Function.From([Number]).To(Function)(function() {
    ...
    return this.Where(function(number) {
      return indexOf.call(numbers, number) >= 0;
  ...
  String.In = Function.From([String]).To(Function)(function() {
    ...
    return this.Where(function() {
      return indexOf.call(strings, this) >= 0;
  ...
  return window.JMPromise = JMPromise = (function() {
    var FULFILLED, PENDING, REJECTED, chain, delay, ref;

    ref = [1, 2, 3], PENDING = ref[0], FULFILLED = ref[1], REJECTED = ref[2];
    ...
    chain = function(promise, fn, value) {
      return delay(function() {
        var reason, ret;
        try {
          ret = fn.call.apply(fn, [value[0]].concat(slice.call(value)));
    ...
    JMPromise.prototype.then = function(fulfilled, rejected) {
      var promise;
    ...
    JMPromise.prototype.fulfil = Function.Requiring(function() {
      return this.status === PENDING;
    })(function() {
      var fulfilled, j, len, promise, ref1, ref2, results, value1;
      value1 = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      this.value = value1;
      this.status = FULFILLED;
      ref1 = this.waiting;
      results = [];
      for (j = 0, len = ref1.length; j < len; j++) {
        ref2 = ref1[j], promise = ref2.promise, fulfilled = ref2.fulfilled;
        results.push(chain(promise, fulfilled, this.value));
      }
      return results;
    });

    JMPromise.prototype.reject = Function.Requiring(function() {
      return this.status === PENDING;
    })(function(reason1) {
      var j, len, promise, ref1, ref2, rejected, results;
      this.reason = reason1;
      this.status = REJECTED;
      ref1 = this.waiting;
      results = [];
      for (j = 0, len = ref1.length; j < len; j++) {
        ref2 = ref1[j], promise = ref2.promise, rejected = ref2.rejected;
        results.push(chain(promise, rejected, [this.reason]));
      }
      return results;
    });

    JMPromise.Fulfilled = Function.Returning(function() {
      return new this;
    })(function(promise) {
      return function() {
        var args;
    ...
    JMPromise.Rejected = Function.Returning(function() {
      return new this;
    })(function(promise) {
      return function() {
        var args;
    ...
    JMPromise.Of = Function.Cache.From(Function).To(Function)(function(constructor) {
      return (function(superClass) {
        extend(_Class, superClass);
    ...
    JMPromise.conjoin = Function.From([JMPromise]).Returning(function() {
      return new this;
      ...
      return function() {
        ...
        completed = function() {
          if (promises.none(function() {
            ...
            return conjunction.fulfil.apply(conjunction, promises.map(function(arg) {
              var ret;
              ret = arg.value[0];
              return ret;
            }));
    ...
    JMPromise.disjoin = Function.From([JMPromise]).Returning(function() {
      return new this;
    })(function(disjunction) {
      return function() {
        var fulfil, promises, ref1, reject;
        promises = 1 <= arguments.length ? slice.call(arguments, 0) : [];
        ref1 = Function.delegates(function() {
          return [disjunction, disjunction.fulfil, disjunction.reject];
        }), fulfil = ref1[0], reject = ref1[1];
