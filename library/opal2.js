...
define(function() {
  ...
  if ((_ref = (_base = Function.prototype).delay) == null) {
    _base.delay = function() {
      ...
      return function() {
        ...
        args2 = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return setTimeout((_ref1 = fn.curry).call.apply(_ref1, [fn].concat(__slice.call(args1), __slice.call(args2))), duration);
      };
    };
  }
  ...
  Type.union = Function.From(Function).Returning(function() {
    ...
    return function(fn) {
      var constructor, name, subtype, subtypes, _i, _len, _ref1, _results, _results1;
  ...
  return window.Promise = Promise = (function() {
    ...
    Promise.disjoin = Function.From([Promise]).Returning(function() {
      ...
      return function() {
        var fulfil, promise, promises, reject, _i, _len, _ref3, _results;

        promises = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        _ref3 = Function.delegates(function() {
          return [disjunction, disjunction.fulfil, disjunction.reject];
        }), fulfil = _ref3[0], reject = _ref3[1];
        _results = [];
