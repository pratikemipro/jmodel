...
define(['jmodel/topaz2', 'plugins/sapphire.dom'], function() {
  ...
  test('Function.From', function() {
    ...
    Person = (function() {
      ...
      class1 = Function.From(String)(function(name1) {
        this.name = name1;
      });
  ...
  test('Function.Defaults', function() {
    ...
    Person = Function.Defaults({
      ...
      this.name = arg.name, this.department = arg.department;
    });
    fred = new Person({
      name: 'Fred'
    });
  ...
  test('Function.From.Returning', function() {
    ...
    deptPerson = Function.From([String]).Returning(function() {
      ...
      return function() {
        var depts;
        depts = 1 <= arguments.length ? slice.call(arguments, 0) : [];
  ...
  test('Function.Chaining', function() {
    ...
    Person = (function() {
      ...
      _Class.prototype.name = Function.Chaining(function(name1) {
        this.name = name1;
      });
  ...
  test('Function::Chaining', function() {
    ...
    Person = (function() {
      ...
      _Class.prototype.name = Function.From(String).Chaining(function(name1) {
        this.name = name1;
      });
  ...
  test('Object.resolve', function() {
    var Person, person;
    Person = (function() {
      function Person(forename1, surname1, age1) {
        this.forename = forename1;
      ...
      Person.prototype.Forename = function(forename1) {
        this.forename = forename1;
        return this;
      };
  ...
  module('JMPromise');
  test('JMPromise.then', function() {
    var promise;
    promise = new JMPromise();
    return equals(promise.then(function() {}) instanceof JMPromise, true, 'Returns a JMPromise');
  });
  ...
  test('JMPromise.fulfil', function() {
    var promise;
    promise = new JMPromise();
    promise.fulfil('fred');
    raises((function() {
  ...
  test('JMPromise.reject', function() {
    var promise;
    promise = new JMPromise();
    promise.reject('fred');
    raises((function() {
  ...
  asyncTest('JMPromise.Fulfilled', 2, function() {
    var promise;
  ...
  asyncTest('JMPromise.Rejected', 2, function() {
    var promise;
  ...
  asyncTest('JMPromise.Of', 2, function() {
    var promise;
  ...
  asyncTest('JMPromise.Of.Fulfilled', 2, function() {
    var promise;
  ...
  asyncTest('JMPromise.Of.Rejected', 1, function() {
    var promise;
  ...
  asyncTest('JMPromise.conjoin', 2, function() {
  ...
  asyncTest('JMPromise.disjoin', 2, function() {
    var delay, output, promise, promise1, promise2, promise3;
    delay = function(fn) {
      return setTimeout(fn, 100);
    };
  ...
  asyncTest('JMPromise.Of.disjoin', 3, function() {
    var delay, output, promise, promise1, promise2, promise3;
    delay = function(fn) {
      return setTimeout(fn, 100);
    };
    ...
    return delay(function() {
      ...
      deepEqual((function() {
        ...
        for (j = 0, len = output.length; j < len; j++) {
          date = output[j];
          results.push(date.toDateString());
        }
        return results;
  ...
  test('Set::where', function() {
    ...
    deepEqual((function() {
      var j, len, results;
      results = [];
      for (j = 0, len = evens.length; j < len; j++) {
        number = evens[j];
        results.push(number);
      }
      return results;
  ...
  test('Set.intersection', function() {
    ...
    deepEqual(((function() {
      var j, len, results;
      results = [];
      for (j = 0, len = intersection.length; j < len; j++) {
        number = intersection[j];
        results.push(number);
      }
      return results;
    ...
    deepEqual((function() {
      var j, len, ref, results;
      ref = Set.intersection(positives);
      results = [];
      for (j = 0, len = ref.length; j < len; j++) {
        number = ref[j];
        results.push(number);
  ...
  test('Set.difference', function() {
    ...
    deepEqual(((function() {
      var j, len, results;
      results = [];
      for (j = 0, len = difference.length; j < len; j++) {
        number = difference[j];
        results.push(number);
      }
      return results;
  ...
  test('Set.Of', function() {
    ...
    deepEqual((function() {
      ...
      for (j = 0, len = dates.length; j < len; j++) {
        date = dates[j];
        results.push(date instanceof Date);
      }
      return results;
  ...
  asyncTest('EventType::drop', 1, function() {
    var numbers, output;
    numbers = new EventType;
    output = [];
  ...
  asyncTest('EventType::transition', 1, function() {
    var numbers, output;
    numbers = new EventType;
    output = [];
  ...
  asyncTest('EventType.Of', 0, function() {
    ...
    ValueChangeEvent = function(value1, old) {
      this.value = value1;
      this.old = old;
    };
